        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="space-y-6">
                ...
                <ul className="space-y-3">
                    {goodFit.map((item) => (
                        <li key={item.text} className="flex items-start text-base text-zinc-600 dark:text-zinc-300">
             ...
             <div className="space-y-6 md:border-l border-zinc-200/80 dark:border-zinc-800/80 md:pl-12">
                 <h3 className="text-xl font-bold text-zinc-900 dark:text-white flex items-center gap-3">
