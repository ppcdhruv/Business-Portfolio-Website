...
const Investment: React.FC = () => {
    const { localizedPlans, isLoading } = useLocalizedPricing(plans);
  ...
  return (
    <section id="pricing" className="pt-20 sm:pt-28 pb-20 sm:pb-28">
        <SectionHeader
            ...
            return (
                ...
                >
                    ...
                    <div className="flex justify-between items-start gap-4">
                        ...
                        <div className="px-3 py-1 text-xs font-semibold tracking-wider text-zinc-600 bg-zinc-100 dark:text-zinc-300 dark:bg-zinc-800/50 border border-zinc-200/80 dark:border-zinc-800/80 rounded-full whitespace-nowrap min-w-[90px] text-center">
                           {isLoading ? (
                               <span className="inline-block w-16 h-4 bg-zinc-200 dark:bg-zinc-700 rounded-sm animate-pulse"></span>
                           ) : (
                               plan.price
                           )}
                        </div>
