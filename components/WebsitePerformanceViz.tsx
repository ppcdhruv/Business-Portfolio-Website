...
const WebsitePerformanceViz: React.FC = () => {
    ...
    return (
        ...
        <motion.div 
            ...
            className="relative w-full max-w-4xl mx-auto aspect-[1.6/1] sm:aspect-[2.2/1] bg-stone-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl flex flex-col"
